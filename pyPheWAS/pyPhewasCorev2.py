...
cat_colors = {'Infections': 'gold',
              'Blood/Immune': 'xkcd:bright red',
              'Congenital': 'mediumspringgreen',
              'Dermatological': 'xkcd:dark peach',
              'Gastrointestinal': 'yellowgreen',
              'Endocrine/Metab': 'darkred',
              'Genitourinary': 'seagreen',
              'Cardiovascular': 'orange',
              'Mental': 'blue',
              'Respiratory': 'slategray',
              'Symptoms': 'xkcd:hot pink',
              'Genetic': 'darkkhaki',
              'Neoplasms': 'xkcd:bluish',
              'Neonatal': 'xkcd:purplish pink',
              'Pregnancy': 'peachpuff',
              'Muscloskeletal': 'xkcd:carolina blue',
...
icd9_codes = get_codes('phecodeX_info_icd9.csv')
icd10_codes = get_codes('phecodeX_info_icd10.csv')
